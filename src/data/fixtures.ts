...
export const commandCentreFixture = {
  ...
  expected: {
    income: [
      { name: 'Super Payments salary', expected: 5400, actual: 5400, due: 'Paid 26 Jun', status: 'Matched', tone: 'ok' },
      { name: 'WEFINDFLATS base salary', expected: 2400, actual: 2400, due: 'Paid 25 Jun', status: 'Matched', tone: 'ok' },
      { name: 'WEFINDFLATS variable income', expected: 0, actual: 1500, due: 'Ad hoc', status: 'Bonus tagged separately', tone: 'neutral' },
    ],
    obligations: [
      { name: 'HMRC payment on account', expected: 2000, due: '31 Jul', status: 'Outstanding', tone: 'watch' },
      { name: 'AMEX statement payment', expected: 1434.82, due: '4 Jul', status: 'Awaiting bank-side transfer', tone: 'watch' },
      { name: 'Council tax', expected: 214, actual: 214, due: 'Paid 3 Jun', status: 'Matched', tone: 'ok' },
    ],
    candidates: [
